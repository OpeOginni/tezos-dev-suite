...
DB_CONTAINER_NAME="tezos-verify-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=tezos-verify -d -p 5432:5432 docker.io/postgres
